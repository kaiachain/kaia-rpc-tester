...
class TestEthNamespaceFilterWS(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestEthNamespaceFilterWS("test_eth_newPendingTransactionFilter_success_wrong_value_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_newPendingTransactionFilter_success"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_uninstallFilter_error_no_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_uninstallFilter_error_wrong_type_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_uninstallFilter_success_false"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_uninstallFilter_success"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_getFilterChanges_error_no_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_getFilterChanges_error_wrong_type_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_getFilterChanges_error_wrong_value_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_getFilterChanges_success"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_getFilterLogs_error_no_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_getFilterLogs_error_wrong_type_param"))
        suite.addTest(TestEthNamespaceFilterWS("test_eth_getFilterLogs_error_wrong_value_param"))
