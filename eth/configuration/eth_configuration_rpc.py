...
class TestEthNamespaceConfigurationRPC(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestEthNamespaceConfigurationRPC("test_eth_coinbase_success"))
        suite.addTest(TestEthNamespaceConfigurationRPC("test_eth_etherbase_success"))
        suite.addTest(TestEthNamespaceConfigurationRPC("test_eth_gasPrice_success_wrong_value_param"))
