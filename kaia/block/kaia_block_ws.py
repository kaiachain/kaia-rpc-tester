...
class TestKaiaNamespaceBlockWS(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKaiaNamespaceBlockWS("test_kaia_getBlockByNumber_error_wrong_value_param1"))
        suite.addTest(TestKaiaNamespaceBlockWS("test_kaia_getBlockByNumber_error_wrong_value_param2"))
        suite.addTest(TestKaiaNamespaceBlockWS("test_kaia_getBlockByNumber_success"))
        suite.addTest(TestKaiaNamespaceBlockWS("test_kaia_getBlockReceipts_error_no_param"))
        suite.addTest(TestKaiaNamespaceBlockWS("test_kaia_getBlockReceipts_error_wrong_type_param"))
        suite.addTest(TestKaiaNamespaceBlockWS("test_kaia_getBlockReceipts_fail_wrong_value_param"))
