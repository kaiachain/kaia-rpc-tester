...
class TestKaiaNamespaceTransactionRPC(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKaiaNamespaceTransactionRPC("test_kaia_sendRawTransaction_Blob_FromRawData_success"))
        ...
        suite.addTest(TestKaiaNamespaceTransactionRPC("test_kaia_getTransactionByBlockHashAndIndex_Blob_success"))
        ...
        suite.addTest(TestKaiaNamespaceTransactionRPC("test_kaia_getRawTransactionByBlockNumberAndIndex_Blob_success"))
        suite.addTest(
        ...
        suite.addTest(TestKaiaNamespaceTransactionRPC("test_kaia_getTransactionReceipt_Blob_success"))
