...
class TestPersonalNamespaceWS(unittest.TestCase):
    ...
    def test_personal_importRawKey_success(self):
        ...
        result, error = Utils.call_ws(self.endpoint, method, [key, passphrase], self.log_path)
        self.assertIsNone(error)
        imported_address = result

        result, error = Utils.call_ws(self.endpoint, f"{self.ns}_listAccounts", [], self.log_path)
        self.assertIsNone(error)
    ...
    def test_personal_unlockAccount_success_no_duration(self):
        ...
        address = test_data_set["account"]["sender"]["address"]
        passphrase = test_data_set["account"]["sender"]["password"]
        _, error = Utils.call_ws(self.endpoint, method, [address, passphrase], self.log_path)
        self.assertIsNone(error)
    ...
    def sign(self, message=None, signer=None, password=None):
        ...
        result, error = Utils.call_ws(self.endpoint, f"{self.ns}_sign", params, self.log_path)
        return result, error
    ...
    def test_personal_ecRecover_success(self):
        ...
        method = f"{self.ns}_ecRecover"
        result, error = Utils.call_ws(self.endpoint, method, [message, signature], self.log_path)
        self.assertIsNone(error)
        recovered = result
    ...
    def suite():
        ...
        suite.addTest(TestPersonalNamespaceWS("test_personal_importRawKey_error_no_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_importRawKey_error_no_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_importRawKey_error_wrong_type_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_importRawKey_error_wrong_type_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_importRawKey_error_wrong_value_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_importRawKey_success"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_listAccounts_success_wrong_value_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_listAccounts_success"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_lockAccount_error_no_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_lockAccount_error_wrong_type_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_lockAccount_error_wrong_type_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_lockAccount_success"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_error_no_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_error_no_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_error_wrong_type_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_error_wrong_type_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_error_wrong_type_param3"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_error_wrong_value_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_success_no_duration"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_unlockAccount_success"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_newAccount_error_no_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_newAccount_error_wrong_type_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_newAccount_success"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_no_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_no_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_no_param3"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_no_param4"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_no_param5"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_no_param6"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_success_no_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_success_no_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_success_no_param3"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_success_no_param4"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_success_no_param5"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_type_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_type_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_type_param3"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_type_param4"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_type_param5"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_type_param6"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_value_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_value_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_value_param3"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_value_param4"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_error_wrong_value_param5"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sendTransaction_success"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sign_error_no_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sign_error_wrong_type_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sign_error_wrong_type_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sign_error_wrong_type_param3"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sign_error_wrong_value_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_sign_success"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_ecRecover_error_no_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_ecRecover_error_wrong_type_param1"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_ecRecover_error_wrong_type_param2"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_ecRecover_error_wrong_value_param"))
        suite.addTest(TestPersonalNamespaceWS("test_personal_ecRecover_success"))
